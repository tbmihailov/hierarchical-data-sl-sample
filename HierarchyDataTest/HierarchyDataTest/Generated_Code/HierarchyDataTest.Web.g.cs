...
namespace HierarchyDataTest.Web
{
    ...
    public sealed partial class AuthenticationContext : global::System.ServiceModel.DomainServices.Client.ApplicationServices.AuthenticationDomainContextBase
    {
        ...
        public AuthenticationContext() : 
                this(new WebDomainClient<IAuthenticationServiceContract>(new Uri("HierarchyDataTest-Web-AuthenticationService.svc", UriKind.Relative)))
        {
        }
    ...
    /// <summary>
    /// The 'ProductGroup' entity class.
    /// </summary>
    [DataContract(Namespace="http://schemas.datacontract.org/2004/07/HierarchyDataTest.Web")]
    public sealed partial class ProductGroup : Entity
    {
        
        private EntityCollection<ProductGroup> _childrenProductGroups;
        ...
        private Nullable<int> _parentProductId;
        ...
        partial void OnParentProductIdChanging(Nullable<int> value);
        ...
        /// <summary>
        /// Gets the collection of associated <see cref="ProductGroup"/> entities.
        /// </summary>
        [Association("ProductGroup_ProductGroup", "Id", "ParentProductId")]
        [XmlIgnore()]
        public EntityCollection<ProductGroup> ChildrenProductGroups
        {
            get
            {
                if ((this._childrenProductGroups == null))
                {
                    this._childrenProductGroups = new EntityCollection<ProductGroup>(this, "ChildrenProductGroups", this.FilterChildrenProductGroups, this.AttachChildrenProductGroups, this.DetachChildrenProductGroups);
                }
                return this._childrenProductGroups;
            }
        }
        ...
        /// <summary>
        /// Gets or sets the associated <see cref="ProductGroup"/> entity.
        /// </summary>
        [Association("ProductGroup_ProductGroup", "ParentProductId", "Id", IsForeignKey=true)]
        [XmlIgnore()]
        public ProductGroup ParentProductGroup
        {
            get
            {
                if ((this._parentProductGroup == null))
                {
                    this._parentProductGroup = new EntityRef<ProductGroup>(this, "ParentProductGroup", this.FilterParentProductGroup);
                }
                return this._parentProductGroup.Entity;
            }
            set
            {
                ProductGroup previous = this.ParentProductGroup;
                if ((previous != value))
                {
                    this.ValidateProperty("ParentProductGroup", value);
                    if ((previous != null))
                    {
                        this._parentProductGroup.Entity = null;
                        previous.ChildrenProductGroups.Remove(this);
                    }
                    if ((value != null))
                    {
                        this.ParentProductId = value.Id;
                    }
                    else
                    {
                        this.ParentProductId = default(Nullable<int>);
                    }
                    this._parentProductGroup.Entity = value;
                    if ((value != null))
                    {
                        value.ChildrenProductGroups.Add(this);
                    }
                    this.RaisePropertyChanged("ParentProductGroup");
                }
            }
        }
        ...
        [DataMember()]
        [RoundtripOriginal()]
        public Nullable<int> ParentProductId
        {
            get
            {
            ...
            set
            {
                if ((this._parentProductId != value))
                {
                    ...
                    this.RaiseDataMemberChanging("ParentProductId");
                    this.ValidateProperty("ParentProductId", value);
                    this._parentProductId = value;
                    this.RaiseDataMemberChanged("ParentProductId");
    ...
    public sealed partial class UserRegistrationContext : DomainContext
    {
        ...
        public UserRegistrationContext() : 
                this(new WebDomainClient<IUserRegistrationServiceContract>(new Uri("HierarchyDataTest-Web-UserRegistrationService.svc", UriKind.Relative)))
        {
        }
...
namespace HierarchyDataTest.Web.Services
{
    ...
    /// <summary>
    /// The domain context corresponding to the 'HierachicalDataService' domain service.
    /// </summary>
    public sealed partial class HierachicalDataContext : DomainContext
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HierachicalDataContext"/> class.
        /// </summary>
        public HierachicalDataContext() : 
                this(new WebDomainClient<IHierachicalDataServiceContract>(new Uri("HierarchyDataTest-Web-Services-HierachicalDataService.svc", UriKind.Relative)))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="HierachicalDataContext"/> class with the specified service URI.
        /// </summary>
        /// <param name="serviceUri">The HierachicalDataService service URI.</param>
        public HierachicalDataContext(Uri serviceUri) : 
                this(new WebDomainClient<IHierachicalDataServiceContract>(serviceUri))
        {
        }
        
        /// <summary>
        /// Initializes a new instance of the <see cref="HierachicalDataContext"/> class with the specified <paramref name="domainClient"/>.
        /// </summary>
        /// <param name="domainClient">The DomainClient instance to use for this domain context.</param>
        public HierachicalDataContext(DomainClient domainClient) : 
                base(domainClient)
        {
            this.OnCreated();
        }
        ...
        /// <summary>
        /// Gets the set of <see cref="ProductGroup"/> entities that have been loaded into this <see cref="HierachicalDataContext"/> instance.
        /// </summary>
        public EntitySet<ProductGroup> ProductGroups
        {
            get
            {
                return base.EntityContainer.GetEntitySet<ProductGroup>();
            }
        }
        
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="ProductGroup"/> entities using the 'GetPRODUCTGROUPS' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="ProductGroup"/> entities.</returns>
        public EntityQuery<ProductGroup> GetPRODUCTGROUPSQuery()
        {
            this.ValidateMethod("GetPRODUCTGROUPSQuery", null);
            return base.CreateQuery<ProductGroup>("GetPRODUCTGROUPS", null, false, true);
        }
        
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="ProductGroup"/> entities using the 'GetRootProductGroups' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="ProductGroup"/> entities.</returns>
        public EntityQuery<ProductGroup> GetRootProductGroupsQuery()
        {
            this.ValidateMethod("GetRootProductGroupsQuery", null);
            return base.CreateQuery<ProductGroup>("GetRootProductGroups", null, false, true);
        }
        ...
        protected override EntityContainer CreateEntityContainer()
        {
            return new HierachicalDataContextEntityContainer();
        }
        
        /// <summary>
        /// Service contract for the 'HierachicalDataService' domain service.
        /// </summary>
        [ServiceContract()]
        public interface IHierachicalDataServiceContract
        {
            
            /// <summary>
            /// Asynchronously invokes the 'GetPRODUCTGROUPS' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/HierachicalDataService/GetPRODUCTGROUPSDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/HierachicalDataService/GetPRODUCTGROUPS", ReplyAction="http://tempuri.org/HierachicalDataService/GetPRODUCTGROUPSResponse")]
            [WebGet()]
            IAsyncResult BeginGetPRODUCTGROUPS(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetPRODUCTGROUPS'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetPRODUCTGROUPS'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetPRODUCTGROUPS' operation.</returns>
            QueryResult<ProductGroup> EndGetPRODUCTGROUPS(IAsyncResult result);
            
            /// <summary>
            /// Asynchronously invokes the 'GetRootProductGroups' operation.
            /// </summary>
            /// <param name="callback">Callback to invoke on completion.</param>
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/HierachicalDataService/GetRootProductGroupsDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/HierachicalDataService/GetRootProductGroups", ReplyAction="http://tempuri.org/HierachicalDataService/GetRootProductGroupsResponse")]
            [WebGet()]
            IAsyncResult BeginGetRootProductGroups(AsyncCallback callback, object asyncState);
            
            /// <summary>
            /// Completes the asynchronous operation begun by 'BeginGetRootProductGroups'.
            /// </summary>
            /// <param name="result">The IAsyncResult returned from 'BeginGetRootProductGroups'.</param>
            /// <returns>The 'QueryResult' returned from the 'GetRootProductGroups' operation.</returns>
            QueryResult<ProductGroup> EndGetRootProductGroups(IAsyncResult result);
            ...
            /// <param name="asyncState">Optional state object.</param>
            /// <returns>An IAsyncResult that can be used to monitor the request.</returns>
            [FaultContract(typeof(DomainServiceFault), Action="http://tempuri.org/HierachicalDataService/SubmitChangesDomainServiceFault", Name="DomainServiceFault", Namespace="DomainServices")]
            [OperationContract(AsyncPattern=true, Action="http://tempuri.org/HierachicalDataService/SubmitChanges", ReplyAction="http://tempuri.org/HierachicalDataService/SubmitChangesResponse")]
            IAsyncResult BeginSubmitChanges(IEnumerable<ChangeSetEntry> changeSet, AsyncCallback callback, object asyncState);
        ...
        internal sealed class HierachicalDataContextEntityContainer : EntityContainer
        {
            
            public HierachicalDataContextEntityContainer()
            {
                this.CreateEntitySet<ProductGroup>(EntitySetOperations.All);
            }
        }
    }
}
